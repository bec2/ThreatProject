...
def page3():
    ...
    class Window3(Frame):
        ...
        def __init__(self, master=None):
            ...
            hint1.place(x=650, y=10)
            hint2.place(x=650, y=30)
            hint3.place(x=650, y=50)
            ...
            text2.place(x=650, y=120)
            text3.place(x=650, y=140)
            text4.place(x=650, y=160)
            text5.place(x=650, y=180)
            text6.place(x=650, y=200)
            text7.place(x=650, y=220)
            text8.place(x=650, y=240)
            text9.place(x=650, y=260)
